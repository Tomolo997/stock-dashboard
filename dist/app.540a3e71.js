...
function _getData() {
  _getData = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.default.mark(function _callee(symbol, limit) {
    var res, data;
...
function _getTicker() {
  _getTicker = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.default.mark(function _callee2() {
    var res, data;
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _context2.prev = 0;
            _context2.next = 3;
            return fetch("http://api.marketstack.com/v1/tickers?access_key=345a3ca0ad78192423875a7895aa8875");
...
},{"moment":"node_modules/moment/moment.js"}],"src/JS/app.js":[function(require,module,exports) {
"use strict";
...
function getDatAndDisplayGraph() {
  ...
  model.getData('fb', 1000).then(function (res) {
    ...
    for (var i = 0; i < model.state.dataOpenDates.length; i++) {
      var element = model.state.dataOpenDates[i];
...
},{"./model":"src/JS/model.js","chart.js":"node_modules/chart.js/dist/Chart.js"}],"../../../../../../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
//# sourceMappingURL=/app.540a3e71.js.map