...
function _getData() {
  _getData = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.default.mark(function _callee(params) {
    var res, data;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return fetch("http://api.marketstack.com/v1/eod/latest?access_key=345a3ca0ad78192423875a7895aa8875&symbols=AAPL");
